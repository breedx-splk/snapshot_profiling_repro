...
const adj = ["Ablaze", "Abrupt", "Accomplished", "Active", "Adored", "Adulated", "Adventurous", "Affectionate", "Amused", "Amusing",
    "AnimalLike", "Antique", "Appreciated", "Archaic", "Ardent", "Arrogant", "Astonished", "Audacious", "Authoritative",
    ...
    "Dramatic", "DrawnOut", "Dripping", "Dumbstruck", "Ebullient", "Elated", "Elegant", "Enchanted", "Energetic",
    ...
    "FreakinAwesome", "Frenetic", "Frenzied", "Friendly", "Amorous", "FromADistance", "Frosted", "Funny", "Furry",
    "Galloping", "Gaping", "Gentle", "Giddy", "Glacial", "Gladness", "Gleaming", "Gleeful", "Gorgeous", "Graceful",
    "Grateful", "Halting", "Happy", "Haunting", "Heavenly", "Hidden", "HighSpirited", "Honor", "Hopeful", "Hopping",
    "Humble", "Hushed", "Hypnotic", "Illuminated", "Immense", "Imperious", "Impudent", "InCharge", "Inflated", "Innocent",
    "Inspired", "Intimate", "Intrepid", "Jagged", "Joking", "Joyful", "Jubilant", "Kindly", "Languid", "LargerThanLife",
    "Laughable", "LicketySplit", "Lighthearted", "Limping", "Linear", "Lively", "Lofty", "LoveOf", "Lovely", "Lulling",
    "Luminescent", "Lush", "Luxurious", "Magical", "Maniacal", "Manliness", "MarchLike", "Masterful", "Merciful", "Merry",
    ...
    "Smooth", "Sneaky", "Soaring", "Sophisticated", "Sparkling", "SpellLike", "Spherical", "Spidery", "Splashing",
    "Splendid", "Spooky", "Sprinting", "Starlit", "Starry", "Startling", "Successful", "Summery", "Surprised",
    "Sympathetic", "Tapping", "Teasing", "Tender", "Thoughtful", "Thrilling", "Tingling", "Tinkling", "TongueInCheek",
